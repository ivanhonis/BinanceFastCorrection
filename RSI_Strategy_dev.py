        ...
        if not self.live_run or self.is_live_data():
            if self.steps_count >= self.MINIMUM_STEPS:
                ...
                if not self.position:
                    ...
                    if self.vrsi[0] < over_sold and self.vrsi[0] > self.vrsi[-1] and self.vrsi[-3] - self.vrsi[-1] > 12:
                        if self.live_run:
                    ...
                    if self.vrsi[0] > over_bought and self.vrsi[0] < self.vrsi[-1] and self.vrsi[-3] - self.vrsi[-1] > -15:
